using UnityEngine; //正确的反射方案 //Jianpingwang 20200908
...
public class PlaneReflection : MonoBehaviour
{
	...
	private void CreateMirrorObjects( Camera currentCamera, out Camera reflectionCamera )
	{
		...
		// Reflection render texture 512 = m_TextureSize
		if( !m_ReflectionTexture || m_OldReflectionTextureSize != 512 )
		{
			if( m_ReflectionTexture )
				DestroyImmediate( m_ReflectionTexture );
			...
			m_OldReflectionTextureSize = 512;
		}
