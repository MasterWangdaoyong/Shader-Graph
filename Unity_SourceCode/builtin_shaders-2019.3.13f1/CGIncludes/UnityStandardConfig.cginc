...
//默认情况下，“简化的标准着色器”是关闭的，不应用于“旧式着色器”
#ifndef UNITY_STANDARD_SIMPLE
//如果没有定义UNITY_STANDARD_SIMPLE
    #define UNITY_STANDARD_SIMPLE 0
    //就定义 UNITY_STANDARD_SIMPLE ＝ 0
#endif

// Setup a new define with meaningful name to know if we require world pos in fragment shader
//设置一个有意义的名称来定义我们是否需要片段着色器中的世界位置
#if UNITY_STANDARD_SIMPLE
//如果 UNITY_STANDARD_SIMPLE 启用
    #define UNITY_REQUIRE_FRAG_WORLDPOS 0
    //则定义 UNITY_REQUIRE_FRAG_WORLDPOS ＝ 0 不生效
#else
//如果 UNITY_STANDARD_SIMPLE 启用以外
    #define UNITY_REQUIRE_FRAG_WORLDPOS 1
    //则定义 UNITY_REQUIRE_FRAG_WORLDPOS ＝ 1 生效
#endif
...
//我们应该沿着切线打包worldPos（保存插值器）
//我们想在移动平台上跳过此步骤，因为worldpos被打包在mediump中
