...
Shader "Dodjoy/Effect/Mask_Alpha_Blend_2Side" 				//修改双面渲染			//添加UV动画     //20200319			//JianpingWang
{            									
Properties 
{	      									
	[Header(Base)] 
	...
	SubShader 
	{
		Pass 
		{
			...
			v2f vert (appdata_t v)
			{
				...
				half2 MaskTexUV = (half2((_SpeedU2*t),(_SpeedV2*t))+v.texcoord1);
